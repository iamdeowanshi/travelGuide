...
public interface IthakaApi {
    ...
    Observable<Response> attractionDownloaded(
            @Header("Authorization") String authorization, @Field("userId") long userId,
            @Field("attractionId") long attractionId);
    ...
    Observable<Response> rateAttraction(
            @Header("Authorization") String authorization, @Field("userId") long userId,
            @Field("attractionId") long attractionId, @Field("value") int rating);
